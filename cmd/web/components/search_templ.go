...
func datasourceSelect(data types.PageData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, ds := range data.Datasources {
			...
			templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.ResolveAttributeValue(ds.Name)
			if templ_7745c5c3_Err != nil {
...
func dateFilters(data types.PageData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.StartDate != nil {
			...
			templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.ResolveAttributeValue(data.StartDate.Format("2006-01-02"))
			if templ_7745c5c3_Err != nil {
		...
		if data.EndDate != nil {
			...
			templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.ResolveAttributeValue(data.EndDate.Format("2006-01-02"))
			if templ_7745c5c3_Err != nil {
